...
export default function CABeforeAfterSlider() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-3">
      <div className="text-xs font-extrabold text-slate-500 uppercase tracking-widest flex items-center gap-1.5">
        <span>🇨🇦</span> Canada Photo 50 × 70 mm Before &amp; After
      </div>

      {/* 50mm x 70mm Aspect Ratio Slider Container */}
      <div
        ref={containerRef}
        onMouseDown={onMouseDown}
        onTouchStart={onTouchStart}
        className="relative overflow-hidden rounded-sm bg-slate-100 shadow-md"
        style={{
          aspectRatio: "50 / 70",
          width: "100%",
          maxWidth: "320px",
      ...
      >
        ...
        {/* AFTER — clipped right (50x70mm Canada Compliant Photo) */}
        <div
          style={{
            position: "absolute",
            inset: 0,
        ...
        >
          <Image
            ...
            alt="After – IRCC & Passport Program compliant Canada 50x70mm photo"
            fill
            style={{
              objectFit: "cover",
              objectPosition: "center",
      ...
      <p className="text-xs text-slate-500 text-center max-w-xs font-medium">
        IRCC &amp; Passport Program · 50 × 70 mm · Plain White BG · Print &amp; Digital
      </p>
    </div>
  );
}
