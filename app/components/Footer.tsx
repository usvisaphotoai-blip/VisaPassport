  ...
  const links = [
    {
      ...
      items: [
        ...
        { label: "US Passport Photo", href: "/us-passport-photo" },
        { label: "DV Lottery Photo", href: "/dv-lottery-photo-2027" },
        { label: "Green Card Photo", href: "/green-card-photo" },
      ],
    },
    {
      title: "Information",
    ...
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-300 py-16 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 mb-4 group opacity-100 hover:opacity-90">
              ...
              <span className="text-xl font-black tracking-tight text-white">
                USVisa<span className="text-lime-500">PhotoAI</span>
              </span>
            </Link>
            <p className="text-sm text-slate-400 max-w-sm mb-6 leading-relaxed">
              Your instant companion for secure and compliant passport, visa, and green card photos. Our AI ensures your digital photos meet all official Department of State guidelines.
            </p>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
          <p>&copy; {new Date().getFullYear()} USVisaPhotoAI. All rights reserved.</p>
