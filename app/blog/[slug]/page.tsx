...
const DEFAULT_FAQ = [
  ...
  { question: 'How much does PixPassport cost?', answer: 'PixPassport processes your photo for a small one-time fee (typically around $6.99). You receive a fully compliant digital file and a 4x6 printable sheet, saving you significant money compared to studio or pharmacy pricing.' },
