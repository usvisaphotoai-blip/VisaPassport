            ...
            <div className="mt-12 lg:mt-0 flex justify-center lg:justify-end">
              ...
              >
                ...
                <div style={{ position: "absolute", inset: 0, zIndex: 1, clipPath: `inset(0 0 0 ${sliderPos}%)`, willChange: "clip-path", pointerEvents: "none" }}>
                  <Image src="https://res.cloudinary.com/dipzpwbbk/image/upload/v1779008016/c24d89b1-ab0e-4f1d-9035-5814bc7b91ca_preview_ip9ogs.jpg" alt="Après — photo biométrique conforme" fill style={{ objectFit: "cover", objectPosition: "center 8%", pointerEvents: "none" }} priority sizes="(max-width: 1024px) 100vw, 500px" />
                </div>
